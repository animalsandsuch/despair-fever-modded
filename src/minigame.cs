...
function createPlayer(%client)
{
	...
	if(%character.trait["Chain Smoker"])
	{
		if(isObject(%roomCloset))
			%roomCloset.spawnItem("0 0 1", "ViceSmokeItem");
		else
			%player.addTool(ViceSmokeItem);
	}
...
function despairCycleStage(%stage)
{
	...
	if(%stage $= "MORNING")
	{
		...
		%choice[%high++] = "\c3/help\c6 contains a lot of useful gameplay information and tips. Check it out!  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "Did you know you can create a custom character with /cc command  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "Did you know we have a <a:discord.gg/9gDaarJ>Discord</a>\c6 channel? Join the discussion!  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "Murder weapon and blood contain a lot more information that you may initially think. Don't write them off!  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "Once investigation period starts, weapons are disabled, but non-standard murders may still happen!  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "You can spamclick people to shove them!  <a:discord.gg/9gDaarJ>Discord</a>";	
		%choice[%high++] = "\c3Investigatives\c6 are incredibly helpful! They can tell time of death, number and type of cuts, choking victims and all the like!  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "If you survive and win as an innocent, you will keep your character AND your room number!  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "Cleaning up the crime scene is impossible once investigation starts.  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "You can loot bodies by pressing \c3Light Key\c6 and clicking an item! Plant stuff using \c3Ctrl+W\c6!  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "\c3Hold-click\c6 and \c3move your mouse\c6 to start carrying a body! Only killers can carry corpses, though.  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "At least two people must scream or examine a body to start the investigation.  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "You can choke people by carrying a body and \c3Holding Rightclick\c6! It will take 6 seconds, however.  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "Instead of focusing on a single person the entire time, you should check as many people as possible for being the killer.  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "You have no idea how important alibis are! If you pay attention and remember who went where, you might figure something out!  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "Fibers can be dropped when you swing your weapon, you get hit or you interact with a body! They also drop if you sleep.  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "Fibers take on the color of your hair, your clothes and your shoes. Coats and hair-hiding masks obscure fibers.  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "You can fake dying messages if you get your hands bloody and /write!  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "Discussing alibis during investigation is a TERRIBLE idea! Use the time you are given to find \c3physical evidence\6!  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "Alibi = a person's movements and actions druing a specified period, usually the approximate Time of Death.  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "Did you know Killer can fake speed with /fakespeed tired or exhausted command.  <a:discord.gg/9gDaarJ>Discord</a>";
		%choice[%high++] = "We also have a <a:https://despair-fever.fandom.com/wiki/Despair_Fever_Wiki>Wiki</a>\c6!  <a:discord.gg/9gDaarJ>Discord</a>";
